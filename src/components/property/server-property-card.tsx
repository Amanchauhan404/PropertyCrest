...
export function ServerPropertyCard({
  property,
  featured = false,
}: {
  property: Property;
  ...
  return (
    ...
    >
      ...
      >
        {isRemoteImage(primaryImage) ? (
          // Uploaded Supabase images are already public CDN assets.
          ...
          <Image
            ...
            sizes={
              featured
                ? "(max-width: 640px) 54vw, (max-width: 1024px) 46vw, 50vw"
                : "(max-width: 640px) 52vw, (max-width: 1024px) 40vw, 33vw"
            }
